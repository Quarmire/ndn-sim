...
//!
//! ```
//! use ndn_sim_studies::{Aodv, RoutingAlgorithm, ShortestPath, TopologyView};
//!
...
//!   2000). The natural fit for ndn-lab because the [`World`](ndn_sim::World) already holds positions
