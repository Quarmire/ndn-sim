...
fn virtual_kernel_runs_exchange_in_virtual_time() {
    ...
    assert_eq!(out.payload, b"pong", "exchange completed under virtual time");
...
fn virtual_kernel_is_bit_reproducible() {
    ...
    assert_eq!(first, second, "identical scenario must replay identically under virtual time");
}
