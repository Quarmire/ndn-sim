...
//! against KNOWN physics/math (802.11 airtime, Friis path loss, PER monotonicity, both-frames-lose
//! collisions, TX-power actuation) so a fidelity regression is caught, not confirmed. (The LoRa
//! anchors — Semtech airtime, ALOHA collisions, duty cycle — moved with the LoRa model to
//! ndn-sim-studies.)
